 ...
 */
class Mail extends Zittme\Framework\Mail
{
	/**
	...
	{
		self::setDefaultDriver(Zittme\Framework\Drivers\Mail\SMTP::getInstance(array(
			'smtp_host' => $host,
			'smtp_port' => $port,
	...
	{
		return Zittme\Framework\MIME::getTypeByFilename($filename);
	}
