...
namespace Zittme\Framework\Drivers\Queue;

use Zittme\Framework\DB as RFDB;
use Zittme\Framework\Drivers\QueueInterface;
use Zittme\Framework\Queue;
...
class DB implements QueueInterface
{
	...
	public function addTask(string $handler, ?object $args = null, ?object $options = null, ?string $priority = null): int
	{
		...
		if ($priority === \Zittme\Framework\Queue::PRIORITY_HIGH)
		{
	...
	public function addTaskAt(int $time, string $handler, ?object $args = null, ?object $options = null, ?string $priority = null): int
	{
		...
		elseif ($priority === \Zittme\Framework\Queue::PRIORITY_LOW)
		{
			$time = $time + 1;
		}
