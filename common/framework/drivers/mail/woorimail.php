 ...
 */
class Woorimail extends Base implements \Zittme\Framework\Drivers\MailInterface
{
	/**
	 * The API URL.
	 */
	...
	public function send(\Zittme\Framework\Mail $message)
	{
		...
		try
		{
			$request = \Zittme\Framework\HTTP::post(self::$_url, $data, $headers, [], ['timeout' => self::$_timeout]);
