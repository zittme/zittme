...
class DateTime
{
	...
	{
		if (isset($_SESSION['Zittme']['timezone']) && $_SESSION['Zittme']['timezone'])
		{
			return $_SESSION['Zittme']['timezone'];
		}
	...
	/**
	 * Get the relative offset between a timezone and Zittme's internal timezone.
	 *
	 * @param string $timezone Timezone identifier, e.g. Asia/Seoul
	 * @param int $timestamp Unix timestamp (optional, default is now)
	 * @return int
	 ...
	 * However, if Zittme is installed for the first time in such a time zone,
