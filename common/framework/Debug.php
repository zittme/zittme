...
class Debug
{
	...
	public static function addEntry($message): void
	{
		...
		{
			$log_entry = str_replace("\0", '', sprintf('Zittme Debug: %s in %s on line %d',
	...
	public static function exceptionHandler(\Throwable $e): void
	{
		...
		// If the exception was thrown in a Zittme Framework class, find out where that class was called.
	...
	public static function registerErrorHandlers(int $error_types): void
	{
		...
		set_error_handler('\\Zittme\\Framework\\Debug::addError', $error_types);
		set_exception_handler('\\Zittme\\Framework\\Debug::exceptionHandler');
		register_shutdown_function('\\Zittme\\Framework\\Debug::shutdownHandler');
	}
