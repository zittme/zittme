...
class DB
{
	...
	public function connect(array $config): void
	{
		...
		$options = array(
			...
			\PDO::ATTR_STATEMENT_CLASS => array('\Zittme\Framework\Helpers\DBStmtHelper'),
		);
		...
		class_exists('\Zittme\Framework\Helpers\DBStmtHelper');
	...
	public function commit(): int
	{
		...
		else
		{
			if (Debug::isEnabledForCurrentUser())
			{
				Debug::addQuery($this->getQueryLog('NESTED COMMIT IGNORED BY Zittme', 0));
			}
		}
