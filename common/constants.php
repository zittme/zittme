...
/**
 * RX_BASEDIR is the SERVER-SIDE absolute path of Zittme (with trailing slash).
 */
define('RX_BASEDIR', str_replace('\\', '/', dirname(__DIR__)) . '/');

/**
 * RX_BASEURL is the CLIENT-SIDE absolute path of Zittme (with trailing slash, not including the domain).
 */
...
if (isset($_SERVER['HTTP_CF_CONNECTING_IP']))
{
	...
	Zittme\Framework\Filters\IpFilter::getCloudFlareRealIP();
}
