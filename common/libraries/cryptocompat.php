 ...
 * 
 * This file is part of Zittme and is licensed under GPLv2 or later.
 */
class CryptoCompat
{
    ...
    public static function encrypt($plaintext, $key)
    {
        ...
        {
            throw new Zittme\Framework\Exception('msg_crypto_not_available');
        }
    ...
    public static function decrypt($ciphertext, $key)
    {
        ...
        if (!Zittme\Framework\Security::compareStrings($mac, $mac_compare))
        {
            return false;
        }
    ...
    {
        return Zittme\Framework\Security::getRandom(self::ENCRYPTION_BLOCK_SIZE, 'binary');
    }
