...
$lang->filter['invalid_homepage'] = '%s biçimi geçersiz. örn.) https://www.zitt.me/';
$lang->filter['invalid_url'] = '%s biçimi geçersiz. örn.) https://www.zitt.me/';
...
$lang->user = 'Üye';
$lang->help = 'Yardım';
$lang->inquiry = 'Görüntüle';
$lang->all = 'Tümü';
$lang->cmd_sort = 'Sırala';
$lang->cmd_cancel_vote = 'Beğeniyi geri al';
$lang->cmd_cancel_vote_down = 'Beğenmemeyi geri al';
$lang->cmd_vote_config = 'Oylama ayarları';
$lang->cmd_declare_config = 'Şikayet ayarları';
$lang->notice_all = 'Genel duyuru';
$lang->not_notice = 'Normal';
$lang->phone_number = 'Telefon numarası';
$lang->new_title = 'Yeni başlık';
$lang->member_message = 'Mesaj';
$lang->mail = 'Posta';
$lang->email = 'E-posta';
$lang->sms = 'SMS';
$lang->push_notification = 'Anlık bildirim';
$lang->mobile_colorset = 'Mobil renk seti';
$lang->deleted_domain = 'Silinmiş alan adı';
$lang->module_title = 'Forum adı';
$lang->meta_keywords = 'SEO anahtar kelimeleri';
$lang->meta_description = 'SEO açıklaması';
$lang->on = 'Açık';
$lang->unit_count = 'kez';
$lang->time_gap['now'] = 'az önce';
$lang->time_gap['sec'] = '%d saniye önce';
$lang->time_gap['secs'] = '%d saniye önce';
$lang->time_gap['day'] = '%d gün önce';
$lang->time_gap['days'] = '%d gün önce';
$lang->time_gap['month'] = '%d ay önce';
$lang->time_gap['months'] = '%d ay önce';
$lang->time_gap['year'] = '%d yıl önce';
$lang->time_gap['years'] = '%d yıl önce';
$lang->about_ipaddress_input = 'IP adresi giriş biçimi<br />Joker karakter (*) kullanabilirsiniz (ör: 192.168.0.*)<br />IP aralığı için tire (-) kullanabilirsiniz (tire ile joker karakter kullanılamaz, ör: 192.168.0.1-192.168.0.254)<br />';
$lang->msg_invalid_ip = 'Belirtilen IP adresi geçersiz.';
$lang->msg_no_root = 'Kök öğe seçilemez.';
$lang->msg_no_shortcut = 'Kısayol seçilemez.';
$lang->msg_select_menu = 'Hedef menüyü seçin';
$lang->msg_db_query_failed = 'Veritabanı sorgusu başarısız oldu.';
$lang->msg_failed_to_load_query = '%s sorgusu yüklenemedi.';
$lang->msg_password_mismatch = 'İki şifre birbiriyle eşleşmiyor. Lütfen yazım hatalarını kontrol edin.';
$lang->msg_security_violation = 'İstek güvenlik politikası tarafından engellendi.';
$lang->msg_sec_upload_blocked = 'Dosya yükleme güvenlik politikası tarafından engellendi.';
$lang->msg_method_not_allowed = 'Bu işlem için bu HTTP metoduna izin verilmiyor.';
$lang->msg_feature_disabled = 'Bu özellik devre dışı.';
$lang->msg_administrator_only = 'Bu sayfaya yalnızca yöneticiler erişebilir.';
$lang->msg_module_is_not_exists = 'İstediğiniz sayfa bulunamadı. Lütfen site yöneticinize başvurun.';
$lang->msg_module_class_not_found = 'İstenen işlemi yürütecek sınıf bulunamadı.';
$lang->msg_empty_content = 'İçerik boş.';
$lang->msg_server_error = 'Sunucu hatası';
$lang->msg_server_error_see_log = 'Sunucunuz hata mesajlarını gizleyecek şekilde yapılandırılmış. Ayrıntılar için sunucunuzun hata günlüğüne bakın.';
$lang->msg_crypto_not_available = 'OpenSSL eklentisi kurulu değil.';
$lang->success_declared_cancel = 'Şikayet başarıyla iptal edildi.';
$lang->success_declare_canceled = 'Şikayetiniz iptal edildi.';
$lang->success_restore = 'Başarıyla geri yüklendi.';
$lang->success_voted_canceled = 'Beğeniniz geri alındı.';
$lang->success_blamed_canceled = 'Beğenmemeniz geri alındı.';
$lang->success_copied = 'Başarıyla kopyalandı.';
$lang->success_added = 'Başarıyla eklendi.';
$lang->failed_voted_already = 'Bu gönderiyi zaten beğendiniz.';
$lang->failed_voted_self = 'Kendi gönderinizi beğenemezsiniz.';
$lang->failed_voted_canceled = 'Yapmadığınız bir beğeniyi geri alamazsınız.';
$lang->failed_voted_cancel = 'Beğeniyi geri alamazsınız.';
$lang->failed_blamed_already = 'Bu gönderiyi zaten beğenmediniz.';
$lang->failed_blamed_self = 'Kendi gönderinizi beğenmeme oyu veremezsiniz.';
$lang->failed_blamed_canceled = 'Yapmadığınız bir beğenmemeyi geri alamazsınız.';
$lang->failed_blamed_cancel = 'Beğenmemeyi geri alamazsınız.';
$lang->failed_declared_already = 'Bu gönderiyi zaten şikayet ettiniz.';
$lang->failed_declared_self = 'Kendi gönderinizi şikayet edemezsiniz.';
$lang->failed_declared_cancel = 'Şikayeti iptal edemezsiniz.';
$lang->confirm_trash = 'Çöp kutusuna taşımak istediğinize emin misiniz?';
$lang->confirm_process = 'İşlemi yapmak istediğinize emin misiniz?';
$lang->comfirm_act_msg = 'Bu %1$s için %2$s işlemini yapmak istediğinize emin misiniz?%3$s';
$lang->msg_eul = '';
$lang->msg_rul = '';
$lang->column_type_list['password'] = 'Şifre';
$lang->column_type_list['tel_v2'] = 'Telefon numarası (1 alan)';
$lang->column_type_list['tel_intl_v2'] = 'Uluslararası telefon numarası (2 alan)';
$lang->column_type_list['homepage'] = 'URL';
$lang->column_type_list['time'] = 'Saat';
$lang->column_type_list['number'] = 'Sayı';
$lang->column_type_list['file'] = 'Dosya yükleme';
$lang->default_folder = 'Varsayılan klasör';
$lang->filter['invalid_float'] = '%s biçimi geçersiz. Lütfen yalnızca sayı girin.';
$lang->filter['invalid_file'] = '%s değeri geçerli bir dosya yüklemesi değil.';
$lang->filter['invalid_extension'] = '%s biçimi geçersiz. Ör: gif, jpg, png';
$lang->security_invalid_session = 'Geçersiz erişim. Kimlik doğrulaması için yeniden giriş yapmalısınız.';
$lang->cmd_robots_tag = 'Arama motoru dizinleme';
$lang->msg_about_robots_tag = 'Arama motorlarının bu sayfayı dizine eklemesine izin ver.';
$lang->pc = 'PC';
$lang->mobile = 'Mobil';
$lang->skip_to_content = 'Menüyü atla';
$lang->yes = 'Evet';
$lang->not = 'Hayır';
$lang->license_agreement = 'Lisans sözleşmesi';
$lang->license = 'GPL v2';
$lang->cmd_license_agree = 'Lisansı anladım ve kabul ediyorum.';
$lang->msg_must_accept_license_agreement = 'Devam edebilmek için lisans sözleşmesini kabul etmelisiniz.';
$lang->image = 'Görsel';
$lang->audio = 'Ses';
$lang->video = 'Video';
$lang->text = 'Metin';
$lang->image_quality = 'Kalite';
$lang->standard = 'Standart';
$lang->unlimited = 'Sınırsız';
$lang->admin = 'Yönetici';
$lang->stop = 'Durdur';
$lang->view_mode = 'Görünüm modu';
$lang->about_view_mode = 'Bu modülün dar ekranlarda nasıl gösterileceğini belirler. Duyarlı görünüm masaüstü temasını korur ve yalnızca liste sayısı, sayfa sayısı gibi dar ekran ayarlarını uygular.';
$lang->view_mode_mobile = 'Yalnızca mobil görünüm';
$lang->view_mode_none = 'Mobil görünüm yok';
$lang->view_mode_responsive = 'Duyarlı görünüm';
$lang->view_mode_inherit = 'Genel ayarı izle';
$lang->view_mode_inherit_current = 'Genel ayarı izle (şu anda: %s)';
$lang->store = 'Mağaza';
