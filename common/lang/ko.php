...
// 발송 메일 공통 레이아웃 (Zittme\Framework\MailTemplate)
$lang->mail_greeting = '%s 님, 안녕하세요.';
$lang->mail_footer_notice = '본 메일은 %s 의 알림 설정에 따라 발송되었습니다.';
$lang->mail_button_fallback = '버튼이 눌리지 않으면 아래 주소를 브라우저에 붙여넣어 주세요.';
$lang->cmd_cancel = '취소';
$lang->cmd_back = '돌아가기';
$lang->cmd_vote = '추천';
...
$lang->msg_dbconnect_failed = 'DB 접속 오류가 발생했습니다. DB 정보를 다시 확인해 주세요.';
$lang->msg_db_query_failed = 'DB 쿼리 오류가 발생했습니다.';
...
$lang->failed_voted_already = '이미 추천한 게시물입니다.';
...
$lang->failed_blamed_already = '이미 비추천한 게시물입니다.';
...
$lang->msg_rul = '를';
$lang->column_type = '형식';
$lang->column_type_list['text'] = '한 줄 입력칸 (text)';
...
$lang->column_type_list['tel'] = '전화번호 (입력란 3개)';
$lang->column_type_list['tel_v2'] = '전화번호 (입력란 1개)';
...
$lang->column_type_list['email_address'] = '이메일 주소';
$lang->column_type_list['kr_zip'] = '한국 주소와 우편번호';
...
$lang->filter['invalid_homepage'] = '%s의 형식이 잘못되었습니다.(예: https://www.zitt.me/)';
$lang->filter['invalid_url'] = '%s의 형식이 잘못되었습니다.(예: https://www.zitt.me/)';
...
// 뷰 모드 (모바일 전용 / 반응형) — 모듈 설정 화면 공용
$lang->view_mode = '뷰 모드';
$lang->about_view_mode = '이 모듈을 좁은 화면에서 어떻게 보여줄지 정합니다. 반응형 뷰는 PC 스킨을 그대로 쓰면서 목록 수·페이지 수 등 좁은 화면용 설정값만 적용합니다.';
$lang->view_mode_mobile = '모바일 전용 뷰';
$lang->view_mode_none = '모바일 뷰 사용 안 함';
$lang->view_mode_responsive = '반응형 뷰';
$lang->view_mode_inherit = '전역 설정 따름';
$lang->view_mode_inherit_current = '전역 설정 따름 (현재: %s)';
$lang->store = '스토어';
$lang->expert_find = '전문가';
