...
$lang->about_widget_fix_width = '선택하면 가로 길이가 고정됩니다.';
...
$lang->about_widget_code = '선택한 위젯에서 요구하는 아래 항목들의 값을 넣고 [코드생성]버튼을 누르면 제일 아래 칸에 템플릿 파일에 적용할 수 있는 코드가 출력 됩니다.';
$lang->about_widget_code_in_page = '아래 필요한 값들을 입력한 후 추가 버튼을 누르면 페이지 내에 위젯이 삽입됩니다.';
$lang->about_widget = '위젯은 레이아웃이나 페이지에서 사용하는 작은 구성요소입니다.
위젯은 내부 페이지 또는 외부 open api와 연동될 수도 있고, 설정을 통해 다양하게 응용될 수 있습니다.
Zittme의 페이지나 레이아웃 모듈을 사용하지 않더라도 [코드생성] 기능을 통해 직접 위젯 추가도 할 수 있습니다.';
...
$lang->display_no = '표시안함';
$lang->display_yes = '표시함';
