...
$lang->about_allow_outlink = 'Allow other websites to link directly to your download URLs.<br />Zittme does not control links to image files that can be embedded directly in a document.<br />in order to block external links to such images, you may need to modify your web server configuration.';
...
$lang->about_allow_outlink_site = 'These referers will always be allowed.<br />Please enter one full address per line: e.g. https://www.zitt.me/';
...
$lang->about_allowed_filetypes = 'Zittme no longer uses the old *.* syntax. Simply list the extensions you wish to allow.<br />Please use a comma (,) to separate items: e.g. doc, zip, pdf';
...
$lang->about_ffmpeg_path = 'Zittme uses ffmpeg to convert video files.';
...
$lang->about_magick_path = 'Zittme uses magick to convert newer image formats such as AVIF and HEIC.<br />Note that the \'convert\' command from previous versions of ImageMagick doesn\'t support these formats.<br />The latest version can be downloaded from their <a href="https://imagemagick.org/script/download.php" target="_blank">official site</a>.';
