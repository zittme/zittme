...
class NcenterliteView extends Ncenterlite
{
	...
	function dispNcenterliteUserConfig()
	{
		...
		{
			throw new Zittme\Framework\Exceptions\NotPermitted('ncenterlite_stop_no_permission_other_user');
		}
		...
		Context::set('sms_available', Zittme\Framework\SMS::getDefaultDriver()->getName() !== 'Dummy');
		Context::set('push_available', count(Zittme\Framework\Config::get('push.types') ?? []) > 0);
	 ...
	 * @throws \Zittme\Framework\Exception
	 */
	function dispNcenterliteUnsubscribeList()
	{
		...
		{
			throw new Zittme\Framework\Exceptions\NotPermitted('msg_unsubscribe_not_permission');
		}
