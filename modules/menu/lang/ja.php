...
$lang->need_core_update = '設置するにはZittmeアップデートが必要です。';
$lang->need_core_update_continue = 'Zittmeアップデートを一緒に行います。続けますか？';
$lang->not_found_module = 'モジュールが存在しません。';
$lang->no_skin = 'スキン無し';
$lang->sitemap_batch_design = 'デザイン選択';
$lang->msg_url_is_required = '有効なURLを入力してください。';
$lang->confirm_menu_delete_desc = 'このメニューに属する投稿・コメント・ファイルなどのコンテンツもすべて削除しますか？';
$lang->confirm_delete_not_contents = 'メニューのみ削除し、コンテンツは残します。';
$lang->skin_settings = 'スキン設定';
$lang->no_use_skin = 'スキンを使用しない';
$lang->menu_desc = '説明';
$lang->menu_icon = 'アイコン';
$lang->about_menu_icon = 'アイコンコードを解釈するかどうか、またその方法はレイアウト制作者に依存します。';
$lang->menu_class = 'HTMLクラス';
$lang->about_menu_class = 'クラス名を解釈するかどうか、またその方法はレイアウト制作者に依存します。';
$lang->theme_design_entry = 'テーマ';
...
$lang->home_sitemap_hint = 'ホーム(開始ページ)があるサイトマップです。';
