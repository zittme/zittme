...
$lang->need_core_update = '설치하려면 Zittme 업데이트가 필요합니다';
$lang->need_core_update_continue = 'Zittme 업데이트가 함께 진행됩니다. 계속하시겠습니까?';
...
$lang->theme_design_entry = '테마';
$lang->theme_not_set = '미설정';
$lang->theme_view_components = '테마 구성 확인';
$lang->theme_components = '테마 구성';
$lang->about_theme_design = '테마는 선택 후 하단의 테마 적용하기를 눌러서 적용할 수 있습니다.';
$lang->confirm_apply_theme = '선택한 테마를 적용하면 현재 레이아웃과 여러 모듈의 스킨이 한꺼번에 바뀝니다. 계속하시겠습니까?';
$lang->cmd_apply_theme = '테마 적용하기';
$lang->msg_theme_not_selected = '적용할 테마를 선택해 주세요.';
$lang->about_responsive_preview = '반응형 뷰는 하나의 스킨으로 좁은 화면까지 감당합니다. 확대해서 크게 보면 넓은 화면 모습을, 좁게 보면 모바일 모습을 그대로 확인할 수 있습니다.';
$lang->home_sitemap_hint = '홈(시작 페이지)이 있는 사이트맵입니다.';
