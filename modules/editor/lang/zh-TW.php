...
$lang->editor_now = '目前設定的編輯器預覽';
$lang->editor_component = '編輯器元件';
$lang->main_editor = '內文編輯器';
$lang->comment_editor = '留言編輯器';
$lang->guide_editor_skin = '編輯器外觀';
$lang->guide_editor_height = '高度';
$lang->guide_editor_toolbar = '工具列';
$lang->editor_toolbar_default = '預設';
$lang->editor_toolbar_simple = '簡易';
$lang->editor_toolbar_hide = '隱藏';
$lang->editor_common_settings = '共用設定';
$lang->guide_additional_css = '額外 CSS 檔案';
$lang->about_additional_css = '若要在編輯器內載入額外的 CSS 檔案（例如網頁字型），請每行輸入一個網址。';
$lang->guide_additional_mobile_css = '行動版額外 CSS 檔案';
$lang->guide_additional_plugins = '載入額外外掛';
$lang->guide_remove_plugins = '移除外掛';
$lang->guide_choose_text_formatting = '內文格式';
$lang->guide_choose_comment_text_formatting = '留言格式';
$lang->guide_choose_font_preview = '預覽';
$lang->guide_choose_font_body = '預設字型';
$lang->guide_choose_font_size_body = '預設字型大小';
$lang->guide_choose_line_height = '行距';
$lang->guide_choose_paragraph_spacing = '段落間距';
$lang->guide_choose_word_break = '換行方式';
$lang->word_break_normal = '亞洲文字以字元為單位換行，拉丁文字以單字為單位換行（預設）';
$lang->word_break_keep_all = '以單字為單位換行';
$lang->word_break_break_all = '以字元為單位換行';
$lang->word_break_none = '不自動換行';
$lang->guide_choose_autoinsert_types = '自動插入';
$lang->autoinsert_types['image'] = '圖片';
$lang->autoinsert_types['audio'] = '音訊';
$lang->autoinsert_types['video'] = '影片';
$lang->autoinsert_paragraph = '新段落';
$lang->autoinsert_inline = '行內';
$lang->about_additional_plugins = '此設定僅在支援額外外掛的編輯器中生效。';
$lang->about_remove_plugins = '此設定僅在支援移除外掛的編輯器中生效。';
$lang->about_unit_default_px = '未指定單位時，一律使用 px。';
$lang->about_unit_default_percent = '未指定單位時，一律使用 %。';
...
$lang->msg_do_you_like_update = '要更新嗎？';
$lang->msg_font_too_big = '字型太大。';
$lang->msg_component_is_disabled = '編輯器元件 %s 已停用。';
$lang->default_editor_settings = '使用預設設定';
$lang->editor_auto_dark_mode = '自動深色模式';
$lang->allow_html = '允許 HTML';
$lang->about_default_editor_settings = '沿用編輯器模組的預設設定。';
$lang->about_editor_auto_dark_mode = '使用深色模式時自動切換為深色外觀。';
$lang->edit['edit_height_auto'] = '自動調整編輯器高度';
