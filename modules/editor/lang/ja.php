...
$lang->guide_editor_skin = 'エディタスキン';
$lang->guide_editor_height = '高さ';
$lang->guide_editor_toolbar = 'ツールバー';
$lang->editor_toolbar_default = '標準';
$lang->editor_toolbar_simple = 'シンプル';
$lang->editor_toolbar_hide = '非表示';
$lang->editor_common_settings = '共通設定';
$lang->guide_additional_css = '追加CSSファイル';
$lang->about_additional_css = 'Webフォントなど、エディタ内で追加で読み込むCSSファイルがある場合は、1行に1つずつURLを入力してください。';
$lang->guide_additional_mobile_css = 'モバイル用追加CSSファイル';
$lang->guide_additional_plugins = '追加プラグインの読み込み';
$lang->guide_remove_plugins = 'プラグインの削除';
$lang->guide_choose_comment_text_formatting = 'テキスト書式';
$lang->guide_choose_font_preview = 'プレビュー';
$lang->guide_choose_line_height = '行間';
$lang->guide_choose_paragraph_spacing = '段落間隔';
$lang->guide_choose_word_break = '折り返し方法';
$lang->word_break_normal = '日本語・中国語・韓国語は文字単位、欧文は単語単位で折り返す（既定）';
$lang->word_break_keep_all = '単語単位で折り返す';
$lang->word_break_break_all = '文字単位で折り返す';
$lang->word_break_none = '長い行を折り返さない';
$lang->guide_choose_autoinsert_types = '自動挿入';
$lang->autoinsert_types['image'] = '画像';
$lang->autoinsert_types['audio'] = '音声';
$lang->autoinsert_types['video'] = '動画';
$lang->autoinsert_paragraph = '新しい段落';
$lang->autoinsert_inline = 'インライン';
$lang->about_additional_plugins = 'この設定は、追加プラグインに対応したエディタでのみ有効です。';
$lang->about_remove_plugins = 'この設定は、プラグインの削除に対応したエディタでのみ有効です。';
$lang->about_unit_default_px = '単位を指定しない場合は px が使用されます。';
$lang->about_unit_default_percent = '単位を指定しない場合は % が使用されます。';
$lang->msg_component_is_disabled = 'エディタコンポーネント %s は無効になっています。';
$lang->default_editor_settings = '既定の設定を使用';
$lang->editor_auto_dark_mode = 'ダークモード自動検出';
$lang->allow_html = 'HTMLを許可';
$lang->about_default_editor_settings = 'エディタモジュールの既定の設定に従います。';
$lang->about_editor_auto_dark_mode = 'ダークモード使用時に自動的にダークスキンへ切り替えます。';
