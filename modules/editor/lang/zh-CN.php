...
$lang->editor_now = '当前设置的编辑器预览';
$lang->editor_component = '编辑器组件';
$lang->main_editor = '正文编辑器';
$lang->comment_editor = '评论编辑器';
$lang->guide_editor_skin = '编辑器皮肤';
$lang->guide_editor_height = '高度';
$lang->guide_editor_toolbar = '工具栏';
$lang->editor_toolbar_default = '默认';
$lang->editor_toolbar_simple = '简洁';
$lang->editor_toolbar_hide = '隐藏';
$lang->editor_common_settings = '通用设置';
$lang->guide_additional_css = '附加 CSS 文件';
$lang->about_additional_css = '如需在编辑器内加载网页字体等附加 CSS 文件，请每行输入一个 URL。';
$lang->guide_additional_mobile_css = '移动版附加 CSS 文件';
$lang->guide_additional_plugins = '加载附加插件';
$lang->guide_remove_plugins = '移除插件';
$lang->guide_choose_text_formatting = '正文样式';
$lang->guide_choose_comment_text_formatting = '评论样式';
$lang->guide_choose_font_preview = '预览';
$lang->guide_choose_font_body = '默认字体';
$lang->guide_choose_font_size_body = '默认字号';
$lang->guide_choose_line_height = '行间距';
$lang->guide_choose_paragraph_spacing = '段落间距';
$lang->guide_choose_word_break = '换行方式';
$lang->word_break_normal = '中日韩文按字符换行，拉丁文按单词换行（默认）';
$lang->word_break_keep_all = '按单词换行';
$lang->word_break_break_all = '按字符换行';
$lang->word_break_none = '长行不换行';
$lang->guide_choose_autoinsert_types = '自动插入';
$lang->autoinsert_types['image'] = '图片';
$lang->autoinsert_types['audio'] = '音频';
$lang->autoinsert_types['video'] = '视频';
$lang->autoinsert_paragraph = '另起一段';
$lang->autoinsert_inline = '行内插入';
$lang->about_additional_plugins = '此设置仅对支持附加插件的编辑器有效。';
$lang->about_remove_plugins = '此设置仅对支持移除插件的编辑器有效。';
$lang->about_unit_default_px = '未指定单位时默认使用 px。';
$lang->about_unit_default_percent = '未指定单位时默认使用 %。';
$lang->font_preview = 'The quick brown fox jumps over the lazy dog.
中文字体预览：排版效果与显示示例。
日本語のフォントプレビューです。';
$lang->msg_avail_easy_update = '此项目有新版本。';
$lang->msg_do_you_like_update = '是否要更新？';
$lang->msg_font_too_big = '字体过大。';
$lang->msg_component_is_disabled = '编辑器组件 %s 已被禁用。';
$lang->default_editor_settings = '使用默认设置';
$lang->editor_auto_dark_mode = '自动深色模式';
$lang->allow_html = '允许 HTML';
$lang->about_default_editor_settings = '沿用编辑器模块的默认设置。';
$lang->about_editor_auto_dark_mode = '使用深色模式时自动切换为深色皮肤。';
$lang->edit['edit_height_auto'] = '自动调整编辑器高度';
