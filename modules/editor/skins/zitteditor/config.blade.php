...
// Responsive view: both sets are prepared by EditorModel::getModuleEditor(), so the
// toolbar and height can be switched in place when the window crosses the
// breakpoint instead of reloading and losing whatever is being written.
if (!empty($responsive_settings))
{
	$ckconfig->responsive_settings = $responsive_settings;
}
