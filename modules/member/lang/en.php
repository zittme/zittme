...
$lang->cmd_confirm_account = 'Verify email';
...
$lang->msg_confirm_account_title = 'Zittme Account Activation';
...
$lang->about_login_failure_except_ip = 'Enter one IP address or range per line.';
...
$lang->cmd_selected_user_manage = 'Manage selected member';
$lang->about_change_user_group = 'Resets the selected group of members.';
...
$lang->login_trial_limit = 'Limit login failures';
...
$lang->msg_mail_authorization = 'To use mail authentication, the webmaster\'s name and e-mail address must be valid.';
$lang->about_column_id = 'The ID used to identify this input field. It must begin with a letter and may contain only letters and numbers.';
$lang->about_temp_password = 'A temporary password has been issued.<br />Be sure to change your password after logging in.<br />';
$lang->about_reset_auth_mail = 'The currently registered e-mail address is %s. If you want to change it, update your member information with the new e-mail address and then resend the authentication mail.';
$lang->about_public_item = 'Choose whether this information is visible to other members as well as yourself.';

// Social login
$lang->sns_login = 'Social login';
$lang->sns_login_with = 'Login';
$lang->sns_login_enable = 'Enable social login';
$lang->about_sns_login_enable = 'When on, the social login buttons configured below appear on the login screen. Off by default.';
$lang->sns_use_service = 'Use this service';
$lang->sns_callback_url = 'Callback URL (Redirect URI)';
$lang->about_sns_callback_url = 'Register this address as the redirect URI in each provider console (Kakao/Naver/Google).';
$lang->sns_my_services = 'Linked social accounts';
$lang->about_sns_my_services = 'Link a social account to sign in quickly without a password.';
$lang->sns_service = 'Service';
$lang->sns_link_status = 'Status';
$lang->sns_link_manage = 'Manage';
$lang->sns_linked = 'Linked';
$lang->sns_not_linked = 'Not linked';
$lang->sns_link = 'Link';
$lang->sns_unlink = 'Unlink';
$lang->confirm_sns_unlink = 'Are you sure you want to unlink this account?';
$lang->msg_sns_already_linked = 'This social account is already used by another member.';
$lang->msg_email_already_exists = 'A member with the same email already exists. Please sign in with that account.';
$lang->msg_errer_api_connect = 'An error occurred while connecting to the social service. Please try again later.';
$lang->identity_verification = 'Identity Verification';
$lang->identity_enable = 'Use identity verification';
$lang->about_identity_enable = 'When enabled, mobile phone identity verification becomes available. Provider credentials (CPID/CPPWD) must also be entered. Default is off.';
$lang->identity_dup_check = 'Block duplicate signups';
$lang->about_identity_dup_check = 'When enabled, verification is rejected if the same person (CI) is already verified on another account. (One account per person)';
$lang->identity_provider = 'Provider';
$lang->about_identity_provider = 'The identity verification provider. Danal is supported now; more providers will be added.';
$lang->identity_callback_url = 'Callback URL';
$lang->about_identity_callback_url = 'Use this address if the provider requires callback registration.';
$lang->identity_redirecting = 'Redirecting to the verification page…';
$lang->identity_success = 'Identity verification completed.';
$lang->identity_failed = 'Identity verification failed. Please try again later.';
$lang->identity_cancelled = 'Identity verification was cancelled.';
$lang->identity_ci_duplicate = 'This identity is already in use. Only one account is allowed per person.';
$lang->identity_verify = 'Verify identity';
$lang->identity_verified = 'Verified';
$lang->identity_not_verified = 'Not verified';
$lang->identity_signup_required = 'Require verification at signup';
$lang->about_identity_signup_required = 'When enabled, new members must complete phone identity verification before signing up.';
$lang->about_identity_signup = 'Phone identity verification is required to complete signup.';
$lang->msg_identity_required = 'Identity verification is required before signup. Please verify first.';
$lang->about_identity_verify_now = 'Press the button below to verify your identity by phone.';
$lang->about_identity_reverify = 'If your information changed, verifying again refreshes the stored data.';
$lang->identity_adult_gate = 'Adult verification gate';
$lang->identity_adult_age = 'Age threshold';
$lang->about_identity_adult_age = 'Visitors must be verified at or above this age to access the modules selected below. Default 19.';
$lang->identity_adult_mids = 'Gated modules';
$lang->about_identity_adult_mids = 'Accessing the checked modules requires adult verification (identity verification + age threshold). Administrators always have access.';
$lang->identity_age_groups = 'Age-based group assignment';
$lang->about_identity_age_groups = 'Members whose verified age is at or above the threshold are added to the group automatically. Members are only added, never removed — remove them manually in member management if needed.';
$lang->identity_age_group_use = 'Use';
$lang->identity_age_group_min = 'Minimum age';
$lang->identity_age_group_unit = 'or older';
$lang->identity_adult_gate_title = 'Adult verification required';
$lang->about_identity_adult_gate = 'This page is only available to members verified as %d or older.';
$lang->about_identity_gate_login = 'Please log in and complete identity verification.';
$lang->about_identity_gate_verify = 'After verification you will be returned to the page automatically.';
$lang->identity_adult_underage = 'You are under %d and cannot access this page.';
$lang->msg_identity_adult_required = 'Adult verification is required for this service.';
$lang->cmd_back = 'Back';
$lang->signup_step_agreement = 'Terms';
$lang->signup_step_form = 'Your info';
$lang->identity_verify_and_continue = 'Verify identity & continue';
$lang->identity_locked_notice = 'Information confirmed by identity verification (name, birthday, phone) cannot be edited directly. Verify again to update it.';
$lang->male = 'Male';
$lang->female = 'Female';
$lang->identity_ci_mismatch = 'This identity does not match your previous verification. You can only re-verify under your own name.';
$lang->identity_find_account = 'Find account by identity verification';
$lang->about_identity_find_account = 'When enabled, the find-account page lets users confirm their account and reset the password via phone identity verification.';
$lang->about_identity_find_account_front = 'Verify your identity by phone to confirm your account and reset the password.';
$lang->identity_account_found = 'Account found';
$lang->identity_no_account = 'No account is registered under this identity.';
$lang->identity_new_password = 'New password';
$lang->identity_new_password2 = 'Confirm new password';
$lang->identity_reset_password = 'Reset password';
$lang->identity_password_changed = 'Your password has been changed. Please log in with the new password.';
$lang->msg_password_mismatch = 'The passwords do not match.';
$lang->identity_ticket_mismatch = 'Verification can only be completed in the browser that started it. Please try again from the beginning.';
$lang->msg_too_many_requests = 'Too many requests. Please try again later.';
