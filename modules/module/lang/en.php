...
$lang->about_domain = 'In order to create more than one virtual site, every club needs to have its own domain name. A sub-domain (e.g., aaa.bbb.com of bbb.com) also can be used. Input the address including the path where Zittme is installed.   ex) www.zitt.me/rx';
$lang->about_vid = 'Users can access via https://Zittmeaddress/ID. You cannot use same site id as the existing module name(mid). Site id should start with an alphabet character. Alphabet characters, numbers and underscore can be used for the site id.';
...
$lang->msg_extra_name_invalid = 'Invalid extra field ID. It must start with an alphabet character and can contain alphabets, numbers, and underscores.';
$lang->msg_extra_name_exists = 'Already registered field ID. Please input another name.';
$lang->msg_extra_type_invalid = 'Invalid extra field type.';
...
$lang->about_module = 'Zittme consists of modules except the basic library. [Module Manage] module will show all installed modules and help you to manage them.';
...
$lang->no_extra_vars = 'No extra variables have been added yet.';
$lang->about_no_extra_vars = 'Click the Add button to create input fields for this board.';
...
$lang->multilingual_desc = 'Zittme supports 12 languages currently. If you want to use another language, translate one set of languages in /common/lang/ folder into that language and send it to us (support@zitt.me).';
