...
$lang->about_domain = '1개 이상의 사이트를 만들기 위해서는 전용 도메인이 있어야 합니다. 독립 도메인이나 서브 도메인이 있으면 되고 Zittme가 설치된 경로까지 같이 넣어주세요. 예) www.zitt.me/rx';
$lang->about_vid = '별도의 도메인이 아닌 https://Zittme주소/ID 로 접속할 수 있습니다. 모듈명(mid)과 중복될 수 없습니다. 첫 글자는 영문으로 시작해야 하고 영문과 숫자 그리고 _ 만 사용할 수 있습니다';
...
$lang->msg_extra_name_invalid = '사용할 수 없는 확장 변수 ID입니다. 영문, 숫자, _를 조합해서 사용할 수 있으며 첫 글자는 영문이어야 합니다.';
$lang->msg_extra_name_exists = '이미 존재하는 확장 변수 ID입니다. 다른 ID를 입력해 주세요.';
$lang->msg_extra_type_invalid = '사용할 수 없는 확장 변수 유형입니다.';
...
$lang->about_module = 'Zittme는 기본 라이브러리를 제외한 나머지는 모두 모듈로 구성되어 있습니다. 모듈 관리 모듈은 설치된 모든 모듈을 보여주고 관리를 돕습니다.';
...
$lang->no_extra_vars = '등록된 확장 변수가 없습니다.';
$lang->about_no_extra_vars = '추가 버튼을 눌러 게시판에서 사용할 입력 항목을 만들 수 있습니다.';
...
$lang->multilingual_desc = '현재 12 종류의 다국어 문자를 지원할 수 있습니다. 다른 종류의 다국어 지원을 원하는 경우 /common/lang/ 폴더의 다국어 가운데 하나의 세트를 번역해서 Zittme 개발자(support@zitt.me)에게 보내주세요.';
