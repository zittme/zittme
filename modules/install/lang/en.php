...
$lang->install_condition_enable = 'Your server is compatible with Zittme.';
$lang->install_store_unwritable_title = 'Store (easy install) write permission notice';
$lang->install_store_unwritable_desc = 'You can continue the installation, but the store in the admin screen will not be able to install packages because the directories below are not writable.';
$lang->install_store_unwritable_hint = 'On web hosting, set the permission of these directories to 707 (or 777) with the file manager. On your own server, give ownership to the web server account with chown.';
$lang->install_condition_disable = 'Your server does not support Zittme.';
...
$lang->disable_rewrite_can_proceed = 'It is OK to continue to install and use Zittme without the "Friendly URL" feature.';
$lang->about_nginx_rewrite = 'nginx requires rewrite rules for short URLs. Click the button below to copy a config generated for this server along with the commands to apply it.';
...
$lang->msg_already_installed = 'Zittme is already installed.';
...
$lang->msg_install_completed = 'Installation has been completed. Thank you for choosing Zittme.';
...
$lang->msg_ftp_installed_realpath = 'Absolute Path of Zittme';
$lang->msg_ftp_installed_ftp_realpath = 'Zittme installation path';
...
$lang->nginx_helper_open = 'Show nginx setup';
$lang->nginx_helper_title = 'nginx Short URL (rewrite) Setup';
$lang->nginx_helper_requirements = 'Prerequisites: only applicable on self-managed servers (VPS/dedicated) with root SSH access. On shared hosting, ask your provider. The content below was generated for your current environment.';
$lang->nginx_helper_commands_label = 'Commands to run via SSH';
$lang->nginx_helper_config_label = 'Generated nginx config';
$lang->nginx_helper_copy = 'Copy';
$lang->nginx_helper_copied = 'Copied!';
$lang->nginx_helper_after = 'After applying, refresh this page — mod_rewrite should show OK. You can continue installation without it.';
