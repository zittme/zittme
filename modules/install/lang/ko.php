<?php
$lang->introduce_title = 'Zittme 설치';
...
$lang->install_store_unwritable_title = '스토어(쉬운설치) 쓰기 권한 안내';
$lang->install_store_unwritable_desc = '설치는 계속할 수 있지만, 아래 디렉터리에 쓰기 권한이 없어 관리자 화면의 스토어에서 자료를 설치할 수 없습니다.';
$lang->install_store_unwritable_hint = '웹 호스팅은 파일 관리자에서 해당 디렉터리 퍼미션을 707(또는 777)로, 개인 서버는 chown 명령으로 웹 서버 계정에 소유권을 부여하면 됩니다.';
...
$lang->disable_rewrite_can_proceed = '짧은 주소를 사용할 수 없더라도 Zittme 설치와 사용에는 지장이 없습니다.';
$lang->about_nginx_rewrite = 'nginx에서 짧은 주소를 사용하려면 rewrite 설정이 필요합니다. 아래 버튼을 누르면 이 서버에 맞게 생성된 설정과 적용 명령을 바로 복사할 수 있습니다.';
...
$lang->msg_ftp_installed_realpath = '설치된 Zittme의 절대경로';
...
$lang->nginx_helper_open = 'nginx 설정 방법 보기';
$lang->nginx_helper_title = 'nginx 짧은 주소(rewrite) 설정';
$lang->nginx_helper_requirements = '전제조건: root SSH 접근이 가능한 자체 서버(VPS·서버호스팅)에서만 적용할 수 있습니다. 공유(웹)호스팅은 호스팅 업체에 요청하세요. 아래 내용은 현재 서버 환경에 맞게 자동 생성되었습니다.';
$lang->nginx_helper_commands_label = 'SSH에서 실행할 명령';
$lang->nginx_helper_config_label = '생성된 nginx 설정';
$lang->nginx_helper_copy = '복사';
$lang->nginx_helper_copied = '복사됨!';
$lang->nginx_helper_after = '적용 후 이 페이지를 새로고침하면 mod_rewrite 항목이 OK로 표시됩니다. 설정하지 않아도 설치는 계속할 수 있습니다.';
