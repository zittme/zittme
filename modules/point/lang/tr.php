...
$lang->msg_level_icon_not_found = 'Seçilen seviye simge seti bulunamadı.<br />Seviye simgeleri ./modules/point/icons/AD/ klasöründe bulunmalı ve şu dosyalardan en az biri yer almalıdır: 1.gif, 1.png, 1.svg';
$lang->disable_read_document_except_robots = 'Arama robotları hariç';
$lang->cmd_point_except_notice = 'Duyurular hariç';
$lang->cmd_point_revert_on_delete = 'Silinince geri al';
$lang->default_group = 'Varsayılan grup';
$lang->point_group_reset_type = 'Değişim türü';
$lang->point_group_ratchet = 'Puan azaldığında değişim';
$lang->point_group_ratchet_yes = 'Puan azalsa bile mevcut grubu koru';
$lang->point_group_ratchet_no = 'Puan azalırsa alt gruba taşı';
$lang->point_voter = 'Başkasının yazısını beğenme';
$lang->point_blamer = 'Başkasının yazısını beğenmeme';
$lang->point_voter_comment = 'Başkasının yorumunu beğenme';
$lang->point_blamer_comment = 'Başkasının yorumunu beğenmeme';
$lang->point_download_file_author = 'Dosyası başkaları tarafından indirildi (resimler hariç)';
$lang->point_read_document_author = 'Yazısı başkaları tarafından okundu';
$lang->point_voted_comment = 'Yorumu beğenildi';
$lang->point_blamed_comment = 'Yorumu beğenilmedi';
$lang->point_update_desc = 'Puanı artırmak için sayının önüne +, azaltmak için - koyup güncelleyin. + veya - koymazsanız puan girdiğiniz değere ayarlanır.';
$lang->give_point = 'Puan ver veya al';
$lang->point_given_prefix = '';
$lang->point_given_suffix = '$point';
$lang->point_time_limit_prefix = 'gönderimden sonraki';
$lang->point_time_limit_suffix = 'güne kadar';
$lang->no_point_date = 'Yorum yazma puanı süresi';
$lang->about_no_point_date = 'Belirlenen tarihten önce yayınlanmış bir yazıya yorum yazılsa bile puan verilmez. (Birim: gün)';
