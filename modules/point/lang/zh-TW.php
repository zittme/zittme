...
$lang->point_io = '啟用積分模組';
$lang->about_point_io = '可開啟或關閉積分模組。若關閉此模組，所有觸發器將自資料庫中刪除，Zittme 核心也不再呼叫。積分紀錄仍會保留。';
$lang->msg_level_icon_not_found = '找不到所選的等級圖示集。<br />等級圖示必須存放於 ./modules/point/icons/NAME/ 資料夾，且至少須包含下列其中一個檔案：1.gif、1.png、1.svg';
$lang->disable_read_document_except_robots = '搜尋引擎除外';
$lang->cmd_point_except_notice = '公告除外';
$lang->cmd_point_revert_on_delete = '刪除時收回';
$lang->default_group = '預設群組';
$lang->point_group_reset_type = '變更方式';
$lang->point_group_ratchet = '積分減少時的處理';
$lang->point_group_ratchet_yes = '積分減少時仍維持目前群組';
$lang->point_group_ratchet_no = '積分減少時移至較低群組';
$lang->point_voter = '推薦他人的文章';
$lang->point_blamer = '反對他人的文章';
$lang->point_voter_comment = '推薦他人的留言';
$lang->point_blamer_comment = '反對他人的留言';
$lang->point_download_file_author = '檔案被他人下載（不含圖片）';
$lang->point_read_document_author = '文章被他人閱讀';
$lang->point_voted_comment = '留言獲得推薦';
$lang->point_blamed_comment = '留言被反對';
$lang->point_update_desc = '若要增加積分請在數字前加上 +，減少則加上 -，然後更新積分。若未加上 + 或 -，積分將直接設定為您輸入的數值。';
$lang->point_given_prefix = '';
$lang->point_given_suffix = '$point';
$lang->point_time_limit_prefix = '發表後';
$lang->point_time_limit_suffix = '天內';
$lang->no_point_date = '留言積分期間';
$lang->about_no_point_date = '對於設定日期之前發表的文章，即使撰寫留言也不會給予積分。（單位為天）';
$lang->day_ago = ' 天前';
