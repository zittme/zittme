...
class PointAdminController extends Point
{
	...
	function procPointAdminReCal()
	{
		...
		Zittme\Framework\Storage::write(\RX_BASEDIR . 'files/cache/pointRecal.txt', $str);
	...
	function procPointAdminApplyPoint()
	{
		...
		if(!file_exists('./files/cache/pointRecal.txt')) throw new Zittme\Framework\Exceptions\InvalidRequest;
