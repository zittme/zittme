...
$lang->about_faceoff['title'] = 'Zittme FaceOff レイアウト管理ツール';
...
$lang->layout_editing_deprecated_p1 = 'レイアウト編集機能は今後サポートされません。すでに編集済みのレイアウトに限り一時的に編集を許可していますが、将来的に完全に削除される可能性があります。';
$lang->layout_editing_deprecated_p2 = 'レイアウト編集機能は、すでに編集済みのレイアウトに限り一時的に提供されます。<br />この画面でソースコードを直接編集することは推奨されません。<br />FTP またはエディタを使用して、元のレイアウトの HTML・CSS ソースコードを直接編集してください。';
$lang->layout_editing_deprecated_p3 = '編集されたソースコードは、以下のファイルに保存されていますのでご参照ください。';
$lang->layout_editing_deprecated_p4 = '元のソースコードは以下のファイルにあり、そこからインクルードまたは参照されている他のファイルが存在する場合があります。';
$lang->layout_editing_deprecated_p5 = '注意: 「初期化」をクリックすると、レイアウトのソースコードが元の状態に戻り、この画面には二度と戻れません。<br />初期化する前に、編集されたソースコードをバックアップしてください。';
$lang->layout_reset_confirmation = 'レイアウトのソースコードを元の状態に初期化しますか？';
$lang->use_responsive_pc_layout = 'PC と同じレスポンシブレイアウトを使用';
$lang->pc_responsive_layout_tab = 'PC / レスポンシブ';
$lang->responsive_badge = 'レスポンシブ';
