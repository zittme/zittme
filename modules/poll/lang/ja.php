...
$lang->poll_no_poll_srl = 'Poll srl の値がありません。';
$lang->poll_no_poll_or_deleted_poll = '削除されたか、無効な投票です。';
$lang->poll_item_members = '%s を選択したユーザー';
$lang->btn_poll_gotovote = '投票画面へ戻る';
$lang->btn_poll_gotoresult = '結果を見る';
$lang->msg_cannot_vote = '投票できません。';
$lang->msg_exceed_max_select = '選択できる最大数を超えました。';
$lang->add_poll_item = '項目を追加';
$lang->msg_can_add_item = '項目を追加できます。';
$lang->msg_cannot_add_item = '項目を追加できません。';
$lang->delete_poll_item = '項目を削除';
$lang->msg_cannot_delete_item = '項目を削除できません。';
$lang->msg_item_title_cannot_empty = '項目は空にできません。';
$lang->msg_cannot_delete_item_poll_exist = 'この項目はすでに選択されているため削除できません。';
