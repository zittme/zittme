...
$lang->importer = 'Импортировать данные Zittme';
...
$lang->about_importer = 'Вы можете импортировать данные Zeroboard4, Zeroboard5 Beta или других программ в Zittme.
...
$lang->xml_path = 'Укажите путь к XML-файлу.';
$lang->data_destination = 'Выберите назначение для данных.';
$lang->document_destination = 'Выберите назначение для записей.';
$lang->guestbook_destination = 'Выберите назначение для данных гостевой книги.';
$lang->found_xml_file = 'XML-файл найден';
$lang->not_found_xml_file = 'XML-файл не найден';
$lang->cannot_allow_fopen_in_phpini = 'Настройки PHP запрещают открытие удалённых файлов.';
$lang->cannot_url_file = 'Ввод URL не поддерживается. Загрузите XML-файл на локальный сервер и укажите путь к нему.';
$lang->cmd_check_path = 'Проверить путь';
$lang->msg_exist_xml_file = 'XML-файл найден.';
