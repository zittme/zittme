...
$lang->about_importer = '不仅可以导入Zeroboard 4，Zb5beta的数据,也可以把其他程序数据导入到Zittme当中。
...
$lang->xml_path = '请输入 XML 文件的路径。';
$lang->data_destination = '请选择数据的目标位置。';
$lang->document_destination = '请选择文章数据的目标位置。';
$lang->guestbook_destination = '请选择留言板数据的目标位置。';
$lang->found_xml_file = '已找到 XML 文件';
$lang->not_found_xml_file = '找不到 XML 文件';
$lang->cannot_allow_fopen_in_phpini = 'php.ini 设置中禁止打开远程文件。';
$lang->cannot_url_file = '不支持输入 URL。请先将 XML 文件上传到本地服务器，然后输入路径。';
$lang->cmd_check_path = '检查路径';
$lang->msg_exist_xml_file = '已找到 XML 文件。';
