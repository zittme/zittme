...
$lang->about_importer = '不僅可以匯入 Zeroboard 4，Zb5beta 的資料，也能夠把其他程式資料匯入到 Zittme 當中。
...
$lang->xml_path = '請輸入 XML 檔案的路徑。';
$lang->data_destination = '請選擇資料的目標位置。';
$lang->document_destination = '請選擇文章資料的目標位置。';
$lang->guestbook_destination = '請選擇留言板資料的目標位置。';
$lang->found_xml_file = '已找到 XML 檔案';
$lang->not_found_xml_file = '找不到 XML 檔案';
$lang->cannot_allow_fopen_in_phpini = 'php.ini 設定不允許開啟遠端檔案。';
$lang->cannot_url_file = '不支援輸入 URL。請先將 XML 檔案上傳至本機伺服器後再輸入路徑。';
$lang->cmd_check_path = '檢查路徑';
$lang->msg_exist_xml_file = '已找到 XML 檔案。';
