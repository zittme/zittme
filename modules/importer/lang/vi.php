...
$lang->importer = 'Chuyển Zittme Data';
...
$lang->about_importer = 'Bạn có thể chuyển Data từ Zeroboard4, Zeroboard5 Beta hay Data của những mã nguồn khác vào Data của Zittme.
Để hiểu rõ hơn công việc này, bạn có thể tham khảo cách chuyển đổi Data của bạn vào Zittme khi bạn đã Upload chúng tại <a href="https://github.com/xpressengine/xe-migration-tool" target="_blank">XML Exporter</a>.';
...
$lang->xml_path = 'Vui lòng nhập đường dẫn của tệp XML.';
$lang->data_destination = 'Chọn đích đến của dữ liệu.';
$lang->document_destination = 'Chọn đích đến của dữ liệu bài viết.';
$lang->guestbook_destination = 'Chọn đích đến của dữ liệu sổ lưu bút.';
$lang->found_xml_file = 'đã tìm thấy tệp XML';
$lang->not_found_xml_file = 'Không tìm thấy tệp XML';
$lang->cannot_allow_fopen_in_phpini = 'Không tìm thấy tệp XML';
$lang->cannot_url_file = 'Không hỗ trợ nhập URL. Vui lòng tải tệp XML lên máy chủ nội bộ rồi nhập đường dẫn.';
$lang->cmd_check_path = 'Kiểm tra đường dẫn';
$lang->msg_exist_xml_file = 'Đã tìm thấy tệp XML.';
