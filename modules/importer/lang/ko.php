...
$lang->cannot_url_file = 'URL 입력은 지원하지 않습니다. 로컬 서버에 XML 파일을 업로드한 후 경로를 입력해 주세요.';
...
$lang->about_importer = '다른 프로그램의 데이터를 XML 형식으로 변환 후 업로드하면 Zittme로 이전할 수 있습니다. <a href="https://xe1.xpressengine.com/index.php?mid=download&amp;category_srl=18324038" target="_blank">XML Exporter</a>를 이용하면 XML파일로 변환할 수 있습니다.';
