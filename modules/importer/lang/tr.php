...
$lang->preprocessing = 'Zittme içe aktarım için hazırlanıyor.';
$lang->importer = 'Zittme Veri Alıcısı';
...
$lang->about_importer = 'Veri Alıcısı Zittme\'ye, Zeroboard4, Zeroboard5 Beta veya başka programların verilerini aktarmada yardımcı olacaktır.
...
$lang->xml_path = 'XML dosyasının yolunu girin.';
$lang->data_destination = 'Verinin hedefini seçin.';
$lang->document_destination = 'Yazı verisinin hedefini seçin.';
$lang->guestbook_destination = 'Ziyaretçi defteri verisinin hedefini seçin.';
$lang->found_xml_file = 'XML dosyası bulundu';
$lang->not_found_xml_file = 'XML dosyası bulunamadı';
$lang->cannot_allow_fopen_in_phpini = 'php.ini ayarlarında uzak dosyaların açılmasına izin verilmiyor.';
$lang->cannot_url_file = 'URL girişi desteklenmiyor. Lütfen XML dosyasını yerel sunucuya yükleyip yolunu girin.';
$lang->cmd_check_path = 'Yolu doğrula';
$lang->msg_exist_xml_file = 'XML dosyası bulundu.';
