...
$lang->importer = 'Transferir los datos de Zittme';
...
$lang->about_importer = 'Es posible trasferir los datos de Zeroboard4, zb5beta o de otros programas a Zittme.
...
$lang->preprocessing = 'Zittme se está preparando para la importación.';
$lang->type_ttxml = 'TTXML';
$lang->import_step_title['99'] = 'Importando datos';
$lang->import_step_desc['121'] = 'Publicaciones:';
$lang->import_step_desc['122'] = 'Libro de visitas:';
$lang->import_step_desc['99'] = 'Importando';
$lang->xml_path = 'Introduzca la ruta del archivo XML.';
$lang->data_destination = 'Seleccione el destino de los datos.';
$lang->document_destination = 'Seleccione el destino de los datos de documentos.';
$lang->guestbook_destination = 'Seleccione el destino de los datos del libro de visitas.';
$lang->found_xml_file = 'archivo XML encontrado';
$lang->not_found_xml_file = 'No se encuentra el archivo XML';
$lang->cannot_allow_fopen_in_phpini = 'No se encuentra el archivo XML';
$lang->cannot_url_file = 'No se admite la introducción de URL. Suba el archivo XML al servidor local e introduzca la ruta.';
$lang->cmd_check_path = 'Comprobar ruta';
$lang->msg_exist_xml_file = 'Se ha encontrado el archivo XML.';
