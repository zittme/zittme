...
$lang->importer = 'Transférer les Données du Zittme';
...
$lang->about_importer = 'Vous pouvez transférer les données de Zeroboard4, de Zeroboard5 Beta ou d\'autres logiciels aux données de Zittme.
...
$lang->import_step_desc['121'] = 'Articles :';
$lang->import_step_desc['122'] = 'Livre d\'or :';
$lang->xml_path = 'Veuillez saisir le chemin du fichier XML.';
$lang->data_destination = 'Sélectionnez la destination des données.';
$lang->document_destination = 'Sélectionnez la destination des données d\'articles.';
$lang->guestbook_destination = 'Sélectionnez la destination des données du livre d\'or.';
$lang->found_xml_file = 'fichier XML trouvé';
$lang->not_found_xml_file = 'Fichier XML introuvable';
$lang->cannot_allow_fopen_in_phpini = 'Fichier XML introuvable';
$lang->cannot_url_file = 'La saisie d\'une URL n\'est pas prise en charge. Veuillez téléverser le fichier XML sur le serveur local, puis saisir le chemin.';
$lang->cmd_check_path = 'Vérifier le chemin';
$lang->msg_exist_xml_file = 'Fichier XML trouvé.';
