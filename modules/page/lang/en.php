...
$lang->about_page_type = 'Select Page Type to build a page. <ol><li>Widget: Create multiple widgets.</li><li>Article: Create articles with titles, contents and tags for posting page. </li><li>External Page: Use external HTML or PHP files in Zittme.</li></ol>';
$lang->opage_path = 'Location of External Document for PC';
$lang->about_opage = 'This module enables to use external html or php files in Zittme. It allows absolute or relative path, and if the url starts with \'http://\' , it can display the external page of the server.';
$lang->about_opage_path = 'Please enter the location of external document. Both absolute path such as \'/path1/path2/sample.php\' or relative path such as \'../path2/sample.php\' can be used. If you input the path like \'http://url/sample.php\', the result will be received and then displayed. This is current Zittme\'s absolute path. ';
...
$lang->about_opage_postprocessing = 'Parse and execute the external document as a PHP script and/or Zittme template. This does not apply to URL paths.<br />Beware that executing untrusted sources can lead to security problems.';
$lang->opage_proc_php = 'Execute PHP code';
$lang->opage_proc_tpl = 'Parse as Zittme template';
