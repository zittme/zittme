...
$lang->msg_comment_waiting_approval = '새 댓글이 등록되어 승인을 기다리고 있습니다.';
$lang->msg_comment_waiting_count = '현재 승인 대기 중인 댓글은 %d건입니다.';
$lang->cmd_approve = '승인하기';
$lang->comment_status = '변경된 상태';
$lang->msg_comment_status_changed_mail = '[%s] 댓글 상태가 %s(으)로 변경되었습니다 : %s';
