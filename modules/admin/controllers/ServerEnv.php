...
class ServerEnv extends Base
{
	...
	public function dispAdminViewServerEnv()
	{
		...
		$info['Zittme_version'] = ZITTME_VERSION;
		$info['date'] = \Zittme\Framework\DateTime::formatTimestampForCurrentUser('Y-m-d H:i:s O') . ' (' . gmdate('Y-m-d H:i:s') . ' UTC)';
		...
		$info['url.rewrite'] = \Zittme\Framework\Router::getRewriteLevel();
