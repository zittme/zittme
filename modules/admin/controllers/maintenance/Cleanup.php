...
namespace Zittme\Modules\Admin\Controllers\Maintenance;

use Context;
use ModuleController;
use ModuleModel;
use Zittme\Framework\Exceptions\InvalidRequest;
...
class Cleanup extends Base
{
	...
	public const CLEANUP_LIST = [
		...
		'common/libraries/ftp.php' => 'deleted',
		'common/libraries/tar.php' => 'deleted',
		'common/manual/server_config/Zittme-nginx-help.md' => 'deleted',
		...
		'modules/autoinstall/autoinstall.model.php' => 'deleted:xe',
		...
		'modules/autoinstall/tpl/css/autoinstall.css' => 'deleted:xe',
		'modules/autoinstall/tpl/filter/' => 'deleted:xe',
		'modules/autoinstall/tpl/js/waiting.js' => 'deleted:xe',
		'modules/autoinstall/tpl/category.html' => 'deleted:xe',
		'modules/autoinstall/tpl/config.html' => 'deleted:xe',
		'modules/autoinstall/tpl/install.html' => 'deleted:xe',
		'modules/autoinstall/tpl/list.html' => 'deleted:xe',
		'modules/autoinstall/tpl/uninstall.html' => 'deleted:xe',
