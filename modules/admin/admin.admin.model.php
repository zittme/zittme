...
class AdminAdminModel extends Admin
{
	...
	{
		return Zittme\Modules\Admin\Models\Favorite::getFavorites(!!$add_module_info);
	}

	public static function isExistsFavorite($site_srl, $module)
	{
		return Zittme\Modules\Admin\Models\Favorite::isFavorite(strval($module));
	}

	public static function getFaviconUrl($domain_srl = 0)
	{
		return Zittme\Modules\Admin\Models\Icon::getFaviconUrl(intval($domain_srl));
	}

	public static function getMobileIconUrl($domain_srl = 0)
	{
		return Zittme\Modules\Admin\Models\Icon::getMobiconUrl(intval($domain_srl));
	}

	public static function getSiteDefaultImageUrl($domain_srl = 0, &$width = 0, &$height = 0)
	{
		return Zittme\Modules\Admin\Models\Icon::getDefaultImageUrl(intval($domain_srl), $width, $height);
	}

	public static function iconUrlCheck($iconname, $default_icon_name, $domain_srl)
	{
		return Zittme\Modules\Admin\Models\Icon::getIconUrl(intval($domain_srl), $iconname);
	}
