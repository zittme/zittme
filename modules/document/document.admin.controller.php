...
class DocumentAdminController extends Document
{
	...
	function procDocumentAdminDeleteChecked()
	{
		...
		if(!$cart) throw new Zittme\Framework\Exception('msg_cart_is_null');
		$document_srl_list= explode('|@|', $cart);
		$document_count = count($document_srl_list);
		if(!$document_count) throw new Zittme\Framework\Exception('msg_cart_is_null');
		// Delete a doc
	...
	function procDocumentAdminInsertExtraVar()
	{
		...
		{
			throw new Zittme\Framework\Exception('msg_extra_name_exists');
		}
	...
	function procDocumentAdminDeleteExtraVar()
	{
		...
		if(!$module_srl || !$var_idx) throw new Zittme\Framework\Exceptions\InvalidRequest;
	...
	function procDocumentAdminMoveToTrash()
	{
		...
		{
			throw new Zittme\Framework\Exception('msg_admin_document_no_move_to_trash');
		}
