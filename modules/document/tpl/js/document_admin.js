...
function doDeleteAllThumbnail() {
    Zittme.ajax('document.procDocumentAdminDeleteAllThumbnail', {}, function(ret_obj) {
...
function doCancelDeclare() {
    ...
    Zittme.ajax('document.procDocumentAdminCancelDeclare', params, function() {
		location.reload();
	});
}
...
function moveVar(type, module_srl, var_idx) {
    ...
    Zittme.ajax('document.procDocumentAdminMoveExtraVar', params, function() {
		location.reload();
	});
}
