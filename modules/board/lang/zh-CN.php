...
$lang->anonymous_except_admin = '管理员不匿名';
$lang->use_consultation = '用作咨询板';
$lang->about_anonymous_except_admin = '管理员的昵称将不会被隐藏。';
$lang->protect_admin_content = '保护管理员内容';
$lang->inline_data_url_limit = '限制 Data URL';
$lang->about_inline_data_url_limit = '限制可能被用来绕过文件大小限制或引发处理故障的 data: URL。<br>此设置同样适用于超级管理员和板块管理员。';
$lang->about_protect_content_update = '评论数达到 %d 条及以上的文章禁止修改。';
$lang->about_protect_content_delete = '评论数达到 %d 条及以上的文章禁止删除。';
$lang->about_protect_comment_update = '回复数达到 %d 条及以上的评论禁止修改。';
$lang->about_protect_comment_delete = '回复数达到 %d 条及以上的评论禁止删除。';
$lang->about_protect_document_regdate = '发表 %d 天后的文章禁止修改或删除。';
$lang->about_protect_comment_regdate = '发表 %d 天后的评论禁止修改或删除。';
$lang->about_protect_admin_content = '超级管理员发表的文章或评论，即使拥有板块管理权限的用户也不能修改或删除。';
$lang->msg_data_url_restricted = '由于 data URL（如内嵌图片）内容过大，发表已被限制。';
$lang->cmd_board_include_days = '包含期间';
$lang->about_board_include_days = '仅汇总最近的文章。若该值设为 0，将汇总所选板块的全部文章。<br />少于 1 天的期间可用小数表示，例如 0.25 天 = 6 小时。';
