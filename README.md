...
[Rhymix](https://rhymix.org)를 fork(가지치기)하여 진행하는 프로젝트로
(Rhymix는 [XpressEngine](https://xe1.xpressengine.com) 1.8의 fork입니다),
누구나 무료로 사용할 수 있고 개발에 참여할 수도 있는 자유 소프트웨어(free software)입니다.

Zittme는 인터넷 공간에서 자유롭게 창작 활동을 하고
다양한 소프트웨어와 콘텐츠를 조합하여 새로운 것을 만들어내는 모든 사용자들을 응원합니다.

### 개발 방향

Zittme는 개발자와 사용자가 서로의 권리와 책임을 존중하는 인터넷 생태계,
...
Zittme를 사용하려면 PHP 7.4 이상, MySQL 또는 MariaDB가 필요합니다.
자세한 설치 환경은 [매뉴얼](https://zitt.me/manual/introduction/requirements)을 참고하십시오.

### 개발 참여

Zittme는 개발자, 디자이너, 번역가 등의 도움과 일반 사용자들의 버그 신고를 환영합니다.
참여를 원하시는 분은 질서있고 효율적인 프로젝트 운영을 위해
[이슈 및 PR 작성 방법](https://zitt.me/manual/contrib/github)과
...
Rhymix는 사용자의 권리를 더욱 보호하고 자유 소프트웨어 본연의 정신에 충실하기 위해 라이선스를 GPL로 되돌렸으며,
Zittme도 동일하게 GPL v2 이상을 따릅니다.
...
홈페이지에 Zittme를 사용하는 것만으로 소스코드를 공개할 의무가 발생하지는 않으며,
...
Zittme is a content management system (CMS) for everyone who wants to create independent homepages to express themselves and build their communities easily and freely.

Zittme is a fork of [Rhymix](https://rhymix.org), which is itself a fork of [XpressEngine](https://xe1.xpressengine.com) version 1.8, and is free software that anyone can use for free and participate.

Zittme cheers everyone who freely creates and/or assembles new things in the Internet space by combining various software and contents.

### Development Direction

Zittme developers want an Internet ecosystem where developers and users respect each other's rights and responsibilities, 
...
we focused on technologies that protect users' sovereignty and open Internet environment. Taking the spirit of ZeroBoard and XpressEngine, which led the growth of the Korean Internet communities in the 1990s and 2000s respectively, Zittme wants to take the lead in recovering and restoring the open web in the crisis of the 2020s.
...
Zittme requires PHP 7.4 or higher, and MySQL or MariaDB.
Please see the [online manual](https://zitt.me/manual/introduction/requirements) for more information on server requirements.

### Participation in Development

Zittme welcomes developers, designers, translators, and bugs to the public.
...
The GPL is commonly adopted by global CMSes such as WordPress, Drupal, and Joomla. The rights and obligations of users and developers of Zittme are the same as those CMSes.
